...
class plgSystemContentbuilder_system extends CMSPlugin
{
    ...
    function onAfterRoute()
    {
        ...
        if (CBRequest::getCmd('option', '') == 'com_content' || CBRequest::getCmd('option', '') == 'com_contentbuilder') {
            ...
            $this->db->setQuery("Update #__contentbuilder_records Set published = 1 Where is_future = 1 And publish_up <> '0000-00-00 00:00:00' And publish_up <= '" . $date->toSql() . "'");
            $this->db->execute();

            $this->db->setQuery("Update #__contentbuilder_records Set published = 0 Where publish_down <> '0000-00-00 00:00:00' And publish_down <= '" . $date->toSql() . "'");
            $this->db->execute();
