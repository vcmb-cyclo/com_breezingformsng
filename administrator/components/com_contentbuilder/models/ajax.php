        ...
        switch($this->_subject){
            ...
            case 'rating':
                ...
                if($result['rating_slots'] == 2 || $rating){
                    ...
                    $rated = JFactory::getSession()->get('rated'.$this->_id.CBRequest::getCmd('record_id',''), false, 'com_contentbuilder.rating');
                    ...
                    {
                        JFactory::getSession()->set('rated'.$this->_id.CBRequest::getCmd('record_id',''), true, 'com_contentbuilder.rating');
                    }
