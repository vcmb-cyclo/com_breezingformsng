...
<div id="editcell">
    ...
    for ($i=0; $i < $n; $i++)
    {
        ...
        $link = JRoute::_( 'index.php?option=com_contentbuilder&controller=users&tmpl='.CBRequest::getCmd('tmpl','').'&task=edit&form_id='.CBRequest::getInt('form_id',0).'&joomla_userid='. $row->id );
