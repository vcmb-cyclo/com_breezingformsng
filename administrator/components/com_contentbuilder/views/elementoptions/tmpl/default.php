        ...
        <table class="admintable" width="95%">
            ...
            ?>
               <tr>
                    ...
                    <td align="left">
                        <textarea class="form-control" style="width:95%;height:100px;" name="hint" id="hint"><?php echo isset($this->element->hint) ? htmlentities($this->element->hint, ENT_QUOTES, 'UTF-8') : '';?></textarea>
                    </td>
               </tr>
            <?php
            }
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="95%">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="max_filesize" id="max_filesize" value="<?php echo htmlentities(isset($this->element->options->max_filesize) && $this->element->options->max_filesize ? $this->element->options->max_filesize : '2M', ENT_QUOTES, 'UTF-8');?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="upload_directory" id="upload_directory" value="<?php echo htmlentities(isset($this->element->options->upload_directory) && $this->element->options->upload_directory ? $this->element->options->upload_directory : '', ENT_QUOTES, 'UTF-8');?>"/>
                    </td>
               </tr>
        </table>
    </fieldset>    
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="95%">
               ...
               <tr>
                    ...
                    ?>
                    <input class="form-check-input" <?php echo in_array($key, $def) ? 'checked="checked" ' : ''; ?>type="checkbox" name="default_value[]" id="default_value<?php echo htmlentities($key, ENT_QUOTES, 'UTF-8'); ?>" value="<?php echo htmlentities($key, ENT_QUOTES, 'UTF-8'); ?>"/>
               ...
               <tr>
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="length" id="length" value="<?php echo isset($this->element->options->length) ?  $this->element->options->length : '';?>"/>
                    </td>
               </tr>
               <?php
               }
               ...
               <tr>
                    ...
                    <td align="left">
                        <input class="form-check-input" type="checkbox" name="horizontal" id="horizontal" value="1"<?php echo isset($this->element->options->horizontal) && $this->element->options->horizontal ? ' checked="checked"' : '';?>/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width: 95%" type="text" name="horizontal_length" id="horizontal_length" value="<?php echo isset($this->element->options->horizontal_length) ? $this->element->options->horizontal_length : '';?>"/>
                    </td>
               </tr>
               <?php
               }
               ...
               <tr>
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="class" id="class" value="<?php echo isset($this->element->options->class) ? htmlentities($this->element->options->class, ENT_QUOTES, 'UTF-8') : '';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="seperator" id="seperator" value="<?php echo isset($this->element->options->seperator) ? htmlentities($this->element->options->seperator, ENT_QUOTES, 'UTF-8') : ',';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="95%">
               <tr>
                    ...
                    <td align="left">
                        <textarea class="form-control" style="width: 95%; height: 100px;" name="default_value" id="default_value" ><?php echo isset($this->element->default_value) ? htmlentities($this->element->default_value, ENT_QUOTES, 'UTF-8') : '';?></textarea>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="width" id="width" value="<?php echo isset($this->element->options->width) ? $this->element->options->width : '';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="height" id="height" value="<?php echo isset($this->element->options->height) ? $this->element->options->height : '';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="maxlength" id="maxlength" value="<?php echo isset($this->element->options->maxlength) ? $this->element->options->maxlength : '';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input class="form-check-input" type="checkbox" name="readonly" value="1" id="readonly""<?php echo isset($this->element->options->readonly) ? ( intval($this->element->options->readonly) ? ' checked="checked"' : '' ) : '';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="95%">
               <tr>
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="default_value" id="default_value" value="<?php echo isset($this->element->default_value) ? htmlentities($this->element->default_value, ENT_QUOTES, 'UTF-8') : '';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="length" id="length" value="<?php echo isset($this->element->options->length) ?  $this->element->options->length : '100%';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="format" id="format" value="<?php echo isset($this->element->options->format) ? $this->element->options->format : '%Y-%m-%d';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="transfer_format" id="transfer_format" value="<?php echo isset($this->element->options->transfer_format) ? $this->element->options->transfer_format : 'YYYY-mm-dd';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="95%">
               ...
               <tr>
                    ...
                    <td align="left">
                        <input class="form-check-input" type="checkbox" name="password" value="1" id="password""<?php echo  isset($this->element->options->password) ? ( intval($this->element->options->password) ? ' checked="checked"' : '' ) : '';?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
    ...
    <fieldset class="adminform">
        ...
        <table class="admintable" width="95%">
                <tr>
                    ...
                    <td align="left">
                        <input class="form-control form-control-sm" style="width:95%;" type="text" name="validation_message" id="validation_message" value="<?php echo htmlentities($this->element->validation_message, ENT_QUOTES, 'UTF-8');?>"/>
                    </td>
               </tr>
               <tr>
                    <td width="100" align="left" class="key">
                    ...
                    <td align="left">
                        <select class="form-select-sm" style="width: 95%;height: 100px;" multiple="multiple" name="validations[]" id="validations">
                         <?php
