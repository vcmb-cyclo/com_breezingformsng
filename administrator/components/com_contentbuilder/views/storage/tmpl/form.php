    ...
    <tr>
        <td width="200" valign="top">
            ...
            <fieldset class="adminform">
                ...
                <tr>
                    <td>
                        <input class="form-control form-control-sm w-100" type="text" id="fieldname" name="fieldname" value=""/>
                    </td>
                </tr>
                <tr>
                    <td width="100">
                ...
                <tr>
                    <td>
                        <input class="form-control form-control-sm w-100" type="text" id="fieldtitle" name="fieldtitle" value=""/>
                    </td>
                </tr>
                <tr>
                    <td width="100">
                ...
                <tr>
                    <td align="right">
                        <textarea class="form-control form-control-sm" style="width: 100%; height: 100px;" id="group_definition" name="group_definition">Label 1;value1
Label 2;value2
            ...
            for ($i=0; $i < $n; $i++)
            {
                ...
                <tr class="<?php echo "row$k"; ?>">
                    ...
                    <td width="100">
                        ...
                        <input class="form-control form-control-sm w-100" onblur="if(this.value=='') {this.value = 'Unnamed';} this.style.display='none';document.getElementById('itemNames_<?php echo $row->id ?>').innerHTML=this.value;document.getElementById('itemNames_<?php echo $row->id ?>').style.display='block';" id="itemNames<?php echo $row->id ?>" type="text" style="display:none; width: 100%;" name="itemNames[<?php echo $row->id ?>]" value="<?php echo htmlentities($row->name, ENT_QUOTES, 'UTF-8')?>"/>
                    </td>
                    <td width="100">
