 ...
 * @since   3.0
 */
function bf_pagination_list_footer($list)
{
 ...
 * @since   3.0
 */
function bf_pagination_list_render($list)
{
...
function bf_pagination_item_active(&$item)
{
	...
	return '<li><a href="' . $item->link . '" title="' . $item->text . '" onclick="document.adminForm.' . $item->prefix . $limit . '; Joomla.submitform();return false;">' . $display . '</a></li>';
}
