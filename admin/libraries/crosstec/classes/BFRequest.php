...
class BFRequest
{
    ...
    {
        // Cast to string, in case BFREQUEST_ALLOWRAW was specified for mask
    ...
    public static function setVar($name, $value = null, $hash = 'method', $overwrite = true)
    {
        ...
        $GLOBALS['_BFREQUEST'][$name]['SET.' . $hash] = true;
        $GLOBALS['_BFREQUEST'][$name]['SET.REQUEST'] = true;
