...
<br />
<a
    href="<?php echo Uri::root() ?>index.php?raw=true&option=com_breezingforms&amp;stripeDownload=true&amp;token=<?php echo $tx_token ?>&amp;form=<?php echo $form_id ?>&amp;record_id=<?php echo $record_id ?>">
