...
if ($confirmed) {
    ?>
    <a
        href="<?php echo Uri::root() ?>index.php?raw=true&option=com_breezingforms&amp;sofortueberweisungDownload=true&amp;tx=<?php echo htmlentities($tx_token) ?>&amp;form=<?php echo intval($formId) ?>&amp;record_id=<?php echo intval($recordId) ?>">
