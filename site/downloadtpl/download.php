...
<br />
<a
    href="<?php echo Uri::root() ?>index.php?raw=true&option=com_breezingforms&amp;paypalDownload=true&amp;tx=<?php echo urlencode($tx_token) ?>&amp;form=<?php echo intval($form_id) ?>&amp;record_id=<?php echo intval($record_id) ?>">
