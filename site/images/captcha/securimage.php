    ...
    protected function validate()
    {
        ...
        if ($code != '') {
            ...
            if ($code == $code_entered) {
                ...
                if ($this->no_session != true) {
                    if(!isset($_SESSION['securimage_code_tries'][$this->namespace])){
                        $_SESSION['securimage_code_tries'][$this->namespace] = 0;
                    }
                    $_SESSION['securimage_code_tries'][$this->namespace]++;
                    if($_SESSION['securimage_code_tries'][$this->namespace] > 1){
